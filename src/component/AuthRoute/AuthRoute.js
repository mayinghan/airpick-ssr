...
import CSALogo from './CSAlogo.jpg';
	...
	return (
		<section>
			<div className='background'>
				<br />
				<center>
					<img src={require('./CSAlogo.jpg')} alt='CSA logo' className='center' />
...
export default withRouter(connect(state=>state, { loadData })(AuthRoute));
