...
import { deleteLodgereq, loadLodgereq, updateLodgereq } from '../../redux/lodge.redux';
...
export default connect(state => state, { updateLodgereq, deleteLodgereq, loadLodgereq })(MyLodgeList);
