...
import { deletePickreq, loadPickreq, updatePickreq } from '../../redux/airpick.redux';
...
export default connect(state => state, { updatePickreq, deletePickreq, loadPickreq })(MyReqList);
